...
TEST(define_var_u64) {
    TOKEN_TEST_INIT("u64::usixfour: 12345");
    TOKEN_ASSERT(U64, 1, 1, 0, 2);
    TOKEN_ASSERT(DEFINE, 1, 4, 3, 4);
    TOKEN_ASSERT(VAR, 1, 6, 5, 12);
...
TEST(fac_file) {
    ...
    TOKEN_ASSERT(U64, 3, 8, 21, 23);
    TOKEN_ASSERT(DEFINE, 3, 11, 24, 25);
    TOKEN_ASSERT(VAR, 3, 13, 26, 26);
    ...
    TOKEN_ASSERT(STRING, 10, 6, 119, 120);
    TOKEN_ASSERT(CAST, 10, 8, 121, 121);
    TOKEN_ASSERT(VAR, 10, 10, 123, 125);
    TOKEN_ASSERT(LPARENS, 10, 13, 126, 126);
    TOKEN_ASSERT(INT, 10, 14, 127, 128);
    TOKEN_ASSERT(RPARENS, 10, 16, 129, 129);
    TOKEN_ASSERT(NEWLINE, 10, 17, 130, 130);
    TOKEN_ASSERT(INT, 11, 1, 131, 131);
    TOKEN_ASSERT(READWRITE, 11, 3, 133, 134);
    TOKEN_ASSERT(STRING, 11, 6, 136, 139);
    TOKEN_ASSERT(NEWLINE, 11, 10, 140, 140);
    TOKEN_ASSERT(END, 12, 1, 141, 141);
    free(str);
}
